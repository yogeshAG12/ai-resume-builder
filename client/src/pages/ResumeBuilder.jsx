  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 sm:py-6">
        <Link
          to={'/app'}
          className='inline-flex items-center gap-2 text-slate-500 hover:text-slate-700 transition-all text-xs sm:text-base'
        >
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8'>
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-visible'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1 overflow-visible'>
